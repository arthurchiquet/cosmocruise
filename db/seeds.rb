...
trip = Trip.create(title: "Galactic Adventure", description: "Embark on an unforgettable journey through the cosmos", category: "Alien World Exploration", location: "Orion Nebula", price_per_day: 5000, departure: "Kennedy Space Center", nb_travelers_max: 5, nb_days_min: 7, user: user)
...
trip = Trip.create(title: "Lunar Excursion", description: "Experience the beauty of Earth's moon up close.", category: "Alien World Exploration", location: "Moon", price_per_day: 2500, departure: "Baikonur Cosmodrome", nb_travelers_max: 14, nb_days_min: 12, user: user)
...
trip = Trip.create(title: "Interstellar Voyage", description: "Travel to distant star systems and encounter alien civilizations.", category: "Luxury Space Cruises", location: "Andromeda Galaxy", price_per_day: 10000, departure: "Kennedy Space Center", nb_travelers_max: 8, nb_days_min: 10, user: user)
...
trip = Trip.create(title: "Martian Expedition", description: "Explore the red planet and witness its unique landscapes", category: "Intergalactic Races", location: "Mars", price_per_day: 3500, departure: "Satish Dhawan Space Centre", nb_travelers_max: 15, nb_days_min: 12, user: user)
...
trip = Trip.create(title: "Zero Gravity Adventure", description: "Experience weightlessness and float in space.", category: "Space Colonization", location: "Low Earth Orbit", price_per_day: 8000, departure: "Baikonur Cosmodrome", nb_travelers_max: 30, nb_days_min: 1, user: user)
...
trip = Trip.create(title: "Jupiter Discovery", description: "Get up close to the largest planet in our solar system.", category: "Intergalactic Races", location: "Jupiter", price_per_day: 6000, departure: "Jiuquan Satellite Launch Center", nb_travelers_max: 11, nb_days_min: 4, user: user)
...
trip = Trip.create(title: "Saturn Rings Expedition", description: "Witness the breathtaking beauty of Saturn's iconic rings.", category: "Intergalactic Races", location: "Saturn", price_per_day: 5500, departure: "Kennedy Space Center", nb_travelers_max: 140, nb_days_min: 7, user: user)
...
trip = Trip.create(title: "Exoplanet Exploration", description: "Discover distant planets orbiting other stars.", category: "Space Colonization", location: "Exoplanet", price_per_day: 7000, departure: "Kourou Space Centre", nb_travelers_max: 100, nb_days_min: 20, user: user)
...
trip = Trip.create(title: "Asteroid Mining Adventure", description: "Join a mining expedition to extract valuable resources from asteroids.", category: "Luxury Space Cruises", location: "Asteroid Belt", price_per_day: 4500, departure: "Kourou Space Centre", nb_travelers_max: 20, nb_days_min: 4, user: user)
...
trip = Trip.create(title: "Neptune Deep Dive", description: "Explore the mysterious depths of Neptune's atmosphere and witness its vibrant blue color.", category: "Intergalactic Races", location: "Neptune", price_per_day: 7000, departure: "Satish Dhawan Space Centre", nb_travelers_max: 50, nb_days_min: 14, user: user)
...
trip = Trip.create(title: "Space Station Expedition", description: "Live and work on a space station orbiting Earth.", category: "Alien World Exploration", location: "International Space Station", price_per_day: 9000, departure: "Jiuquan Satellite Launch Center", nb_travelers_max: 5, nb_days_min: 7, user: user)
